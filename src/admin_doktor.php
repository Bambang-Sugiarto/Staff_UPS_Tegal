            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Direktori Doktor</h1>
                        <a href="admin.php" class="btn btn-primary">Tambah Data</a>
                    </div>

                    <div class="card">
                        <div class="card-body">
                            <h5 style="color: green;">Jumlah Direktori Doktor : <span class="badge bg-success px-3"><?= $jumlah_doktor; ?></span> </h5>
                            <table class="table table-striped table-hover" style="display: block; padding: 5px; margin-top: 5px; width: auto; height: auto; overflow: auto;">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $query = "SELECT * FROM tb_daftar WHERE jafung='Doktor'";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="hapus.php?id_doktor=<?= $row['id']; ?>" onclick="return confirm('Apakah anda yakin?');"><span class="badge bg-danger">Hapus</span></a>
