            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Direktori Pejabat</h1>
                        <a href="admin.php" class="btn btn-primary">Tambah Data</a>
                    </div>

                    <div class="card">
                        <div class="card-body">
                            <h5 style="color: green;">Jumlah Direktori Pejabat : <span class="badge bg-success px-3"><?= $jumlah_pejabat; ?></span> </h5>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="hapus.php?id_jabatan=<?= $row['id']; ?>" onclick="return confirm('Apakah anda yakin?');"><span class="badge bg-danger">Hapus</span></a>
