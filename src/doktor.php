    ...
    <div class="container py-5">
      <div class="row py-4">
        <div class="col-lg-8 col-sm-12 m-auto pt-5 text-center">
          ...
          <h1>DIREKTORI DOKTOR</h1>
          <p>Berikut ini adalah direktori doktor di lingkungan Universitas Pancasakti Tegal</p>
  ...
  <div class="container">
    <div class="row judul">
      <div class="col-md-6 col-sm-12 m-auto text-center">
        ...
        ?>
        <span>Jumlah Data Yang Ditemukan : <?= $jumlah_doktor; ?></span>
      </div>
    </div>
