    ...
    <div class="container py-5">
      <div class="row py-4">
        <div class="col-lg-8 col-sm-12 m-auto pt-5 text-center">
          ...
          <h1>DIREKTORI STAFF</h1>
          <p>Berikut ini adalah direktori staff di lingkungan Universitas Pancasakti Tegal</p>
  ...
  <div class="container">
    <div class="row judul">
      <div class="col-md-6 col-sm-12 m-auto text-center">
        ...
        ?>
        <span>Jumlah Data Yang Ditemukan : <?= $jumlah_staff; ?></span>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <?php
      /// $query = "SELECT * FROM tb_daftar WHERE pendidikan in ('SD','SMP','SMA','S1')";
