    ...
    <div class="container py-5">
      <div class="row py-4">
        <div class="col-lg-8 col-sm-12 m-auto pt-5 text-center">
          ...
          <h1>DIREKTORI PROFESOR</h1>
          <p>Berikut ini adalah direktori profesor di lingkungan Universitas Pancasakti Tegal</p>
  ...
  <div class="container">
    <div class="row judul">
      <div class="col-md-6 col-sm-12 m-auto text-center">
        <h1>Data Profesor</h1>
        <span>Jumlah Data Yang Ditemukan : <?= $jumlah; ?></span>
      </div>
    </div>
    <div class="row">
      ...
      <?php
      $query = "SELECT * FROM tb_daftar WHERE jafung = 'Profesor'";
